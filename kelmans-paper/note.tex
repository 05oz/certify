...
$(f\mkern-2mu2)$; the captured control log's own header line prints
$15692$ for this total, an arithmetic slip in the log and not in the
count --- its \texttt{RSUMMARY} two lines below reads
