...
ledger lines to files. The LRAT corpus is a regenerable cache and is not
shipped, so no shipped certificate depends on a hash for its replay; regenerating a case formula to its recorded
